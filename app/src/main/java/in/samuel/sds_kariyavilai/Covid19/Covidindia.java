...
public class Covidindia extends AppCompatActivity implements MainInfoContentCardsAdapter.CardClicked{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_covidindia);

        Toast.makeText(getApplicationContext(),"Pray for India",Toast.LENGTH_LONG).show();
        ...
        layoutManager=new GridLayoutManager(Covidindia.this,2,GridLayoutManager.VERTICAL,false);
        recyclerView.setLayoutManager(layoutManager);
        marker = new MyGraphMarker(Covidindia.this,R.layout.marker_view);
        RefreshFunc();
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item)
    {
        switch (item.getItemId())
        {
            case R.id.refresh:
                ...
                break;
            case R.id.about:
                Toast.makeText(Covidindia.this,"Designed and Developed by SDS",Toast.LENGTH_SHORT).show();
                break;
        }
    ...
    {
        Intent intent=new Intent(Covidindia.this, StateDataActivity.class);
    ...
    {
        Intent intent1=new Intent(Covidindia.this, StateDataActivity.class);
    ...
    private class RetrieveCovidData extends AsyncTask<Void, Void,ArrayList<MainInfoContentCards>>
    {
        ...
        protected ArrayList<MainInfoContentCards> doInBackground(Void... arg0)
        {
            ...
            if (jsonStr != null)
            {
                ...
                } catch (final JSONException e)
                {
                    ...
                    Toast.makeText(Covidindia.this,"Json parsing error!",Toast.LENGTH_LONG).show();
        ...
        protected void onPostExecute(ArrayList<MainInfoContentCards> result) {
            ...
            if(result.isEmpty())
            {
                ...
                AlertDialog.Builder alert=new AlertDialog.Builder(Covidindia.this);
            ...
            {
                myAdapter=new MainInfoContentCardsAdapter(Covidindia.this,result);
